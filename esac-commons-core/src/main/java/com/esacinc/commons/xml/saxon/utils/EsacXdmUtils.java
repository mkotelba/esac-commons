package com.esacinc.commons.xml.saxon.utils;
...
public final class EsacXdmUtils {
    private EsacXdmUtils() {
    }

    public static Stream<XdmNode> streamNodes(XdmSequenceIterator iterator) {
        return EsacStreamUtils.asInstances(streamItems(iterator), XdmNode.class);
    }
    ...
    public static Stream<XdmAtomicValue> streamAtomicValues(XdmSequenceIterator iterator) {
        return EsacStreamUtils.asInstances(streamItems(iterator), XdmAtomicValue.class);
    }

    public static Stream<XdmItem> streamItems(XdmSequenceIterator iterator) {
        return EsacIteratorUtils.stream(iterator);
    }
