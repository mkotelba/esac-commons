...
public abstract class AbstractEsacBeanPostProcessor<T> implements BeanFactoryAware, BeanPostProcessor {
    protected Class<T> beanClass;
    protected ConfigurableListableBeanFactory beanFactory;

    protected AbstractEsacBeanPostProcessor(Class<T> beanClass) {
