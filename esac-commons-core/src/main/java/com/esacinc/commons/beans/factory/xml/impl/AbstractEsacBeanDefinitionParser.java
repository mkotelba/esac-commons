...
public abstract class AbstractEsacBeanDefinitionParser extends AbstractBeanDefinitionParser implements EsacBeanDefinitionParser {
    protected EsacNamespaceHandler nsHandler;
    protected Map<String, Class<?>> elemBeanClasses = new TreeMap<>();

    protected AbstractEsacBeanDefinitionParser(EsacNamespaceHandler nsHandler, Map<String, Class<?>> elemBeanClasses) {
    ...
    protected AbstractBeanDefinition parseDefinition(ParserContext parserContext, BeanDefinitionRegistry beanDefRegistry, Element elem, String elemNsPrefix,
        ...
        if (beanDef.hasAttribute(BeanDefinitionParserDelegate.ABSTRACT_ATTRIBUTE) && EsacOptionUtils
